...
export default function AddEquipmentModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-full max-w-5xl shadow-lg border border-yellow-400">
        <h2 className="text-xl font-bold text-yellow-700 mb-6">Add New {category} Equipment</h2>

        <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 text-black">
          ...
          <div className="flex flex-col items-center justify-start">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-6">
              <button
                type="submit"
                className="bg-yellow-400 text-black px-4 py-2 rounded hover:bg-yellow-700 hover:text-white"
              >
                Submit
              </button>
              <button
